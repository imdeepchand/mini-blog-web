...
const MyBlogs = () => {
    ...
    const loadMyBlog = async () => {
        const res = await BlogServices.loadMyBlogs({ page: 1, limit: 10, search: "" })
        ...
        <Container className="py-4">
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <Form className="d-flex gap-2">
                    ...
                    <button className="blog-add-btn" onClick={handleOpenModal}>+ Add</button>
                </Form>
            </div>
            ...
            {showModal && localStorage.getItem("token") && (
                <BlogCreateModal
